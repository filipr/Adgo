...
gridName ='square-11.str.8192.grid'
subGridName = 'na.subgrid'
# GEOMETRY
p1= Point(-1.0, -1.0)
p2= Point(1.0, 1.0)
...
# points used to generate SUBGRID
#x  = []
#x.append( [p5[0], p5[1]] )
#x.append( [p5[0], p6[1]] )
#x.append( [p6[0], p6[1]] )
...
# LL shaped 
#domain = mshr.Rectangle(p1,p2) - mshr.Rectangle(p5,p2) 
#domain.set_subdomain(1, mshr.Rectangle(p3, p4) ) 
#domain.set_subdomain(2, domain - mshr.Rectangle(p3, p4) )  


# CROSS domain 
#domain = mshr.Rectangle(p1,p2) + mshr.Rectangle(p3,p4) 
#domain.set_subdomain(1, mshr.Rectangle(p5, p6) ) 
#domain.set_subdomain(2, domain - mshr.Rectangle(p5, p6) ) 
...
#mesh2d = refine( mesh2d )  

mesh2d = RectangleMesh(p1, p2, N, N, "left")
