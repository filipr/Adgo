...
if($argv[9] == 'A') then
  ...
  set type_tab = "STDGM"
   ...
   set ttime = 1.0 
   set nBC = 4 
   set iord = 3 # 5 # podle ceho se pocita rad konv 
   set Re = 1.0 
   set estim_space = "RTNst"
   set type_tab = "RTNst"
   
else if ($argv[9] == 'RTNtime' ) then 
   set icase = 7 #42 
   set paramet = 0.0 
   set ttime = 1.0 
   set nBC = 8 
#   set iord = 3 # h,tau atd... 
   set iord = 3 # 5= ST 
   set Re = 1.0 
   set estim_space = "RTNst"
   set type_tab = "RTNst"

else if ($argv[9] == 'RTN2' ) then 
   set icase = 2 
   set paramet = 0.0 
   set ttime = 1.0 
   set nBC = 8 
   ...
   set estim_space = "RTNst"
   set type_tab = "RTNst"
   set mesh_name = square-11.uns
   set algeb = 1E-9
   set lin_tol = 1E-9
   
else if ($argv[9] == 'DUA' ) then 
   set icase = 7 
   set paramet = 0.0 
   set ttime = 1.0 
   set nBC = 8 
